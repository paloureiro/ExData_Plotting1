...
# After transforming the "timestamp" column to a POSIX format, four graphs are plotted 
...
# upper right plot
plot(as.POSIXct(consumption_df_excerpt$timestamp,label=T),consumption_df_excerpt$Voltage,type="l",
...
legend("topright",legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,col=c("black","red",
                                                                                             "blue"))
# lower right plot
plot(as.POSIXct(consumption_df_excerpt$timestamp,label=T),consumption_df_excerpt$Global_reactive_power,type="l",
